...
export default function MyProfile() {
    ...
    const updateUserProfileData = async () => {
        try {
            ...
            formData.append('region', userData.region); // Add region to form data
            formData.append('age', userData.age); // Add age to form data
        ...
        <div className='max-w-lg flex flex-col gap-2 text-sm'>
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
                    ...
                    {isEdit
                        ? <input className='bg-gray-100' type='text' onChange={(e) => setUserData(prev => ({ ...prev, region: e.target.value }))} value={userData.region} />
                        : <p className='text-gray-400'>{userData.region}</p>
                    }
