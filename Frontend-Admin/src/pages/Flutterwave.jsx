...
const FlutterWave = () => {
  ...
  const config = {
    ...
    amount: docFees, // Replace with the actual payment amount
    currency: "USD",
    ...
    customizations: {
      title: "Morgp Health",
      description: `Appointment Payment for Dr. ${docName}. from ${userName}`, // Payment description with doctor's name
