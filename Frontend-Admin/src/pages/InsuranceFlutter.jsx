...
const InsuranceFlutterWave = () => {
  ...
  const config = {
    ...
    amount: price, // Replace with the actual payment amount
    currency: "USD",
    payment_options: "card,mobilemoney,ussd",
    customer: {
      email: email, // Replace with actual email
      phone_number: "1234", // Replace with actual phone number
      name: name, // User's name from URL params
    },
    customizations: {
      title: "Morgp Health",
      description: `Insurance Payment for  ${name}`, // Payment description with doctor's name
